...
public class Product implements Serializable {
	...
	@NotBlank(message = "Not Null Descriptions")
	...
	public String toString() {
		return "Product [product_id=" + product_id + ", brand=" + brand + ", name=" + name + ", description="
				...
				+ ", category_name=" + category_name + ", cartItem=" + cartItem + ", farmer_id=" + farmer_id
				+ ", manufacturer_id=" + manufacturer_id + ", retailer_id=" + retailer_id + "]";
	}
}