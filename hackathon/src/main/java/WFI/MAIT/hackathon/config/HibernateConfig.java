package WFI.MAIT.hackathon.config;
...
@Configuration
@ComponentScan(basePackages={"WFI.MAIT.hackathon"})
@EnableTransactionManagement
public class HibernateConfig {
	BasicDataSource dataSource;
	//Change the below final variable value based on database you choose
	
private final static String DATABASE_URL="jdbc:h2:~/Hackathon";
...
public SessionFactory getSessionFactory(DataSource datasource)
{
	...
	builder.scanPackages("WFI.MAIT.hackathon.dto");
