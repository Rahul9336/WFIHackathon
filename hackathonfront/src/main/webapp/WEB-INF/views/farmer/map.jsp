...
<body>
	 ...
	 <div id="map" style="height:500px;width:50%;margin:auto;"></div>
...
    </script>
    <script async defer
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyBjix9SNP-_aC2c0bW6aPDo6hX_eN3R-E0&callback=initMap">
    </script>
